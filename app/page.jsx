        ...
        <>
            ...
            <div className='flex flex-col items-center py-32 bg-base-300'>
                ...
                <div className="grid grid-cols-4 gap-4 w-10/12">
                    <div className='m-4'>
                        <svg className="fill-white aspect-square m-12" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 118.875 122.877" xmlSpace="preserve">
                    ...
                    <div className='m-4'>
                        <svg className="fill-white aspect-square m-12" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 90.63 122.88" xmlSpace="preserve">
                    ...
                    <div className='m-4'>
                        <svg className="fill-white aspect-square m-12" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 122.88 101.878" xmlSpace="preserve">
                    ...
                    <div className='m-4'>
                        <svg className="fill-white aspect-square m-12" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 85.07 122.88" xmlSpace="preserve">
