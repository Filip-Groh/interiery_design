...
const DatabasePreview = ({title, beforePath, afterPath, beforeDescription, afterDescription}) => {
    return (
        <div className="flex justify-center w-full">
            <div className="diff aspect-[16/9] w-full rounded-2xl relative m-2">
                ...
                <div className="font-bold absolute bottom-2 left-1/2 -translate-x-1/2 z-10 bg-black bg-opacity-50 rounded-lg px-2 py-1">
                    <p className="leading-4 text-center">{title}</p>
                </div>
            </div>
        </div>
    )
