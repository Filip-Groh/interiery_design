    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center py-16 bg-base-300">
                <h2 className='text-xl my-2 mt-4 text-neutral'>Kontaktujte nás, přijedeme za vámi</h2>
                <p className='text-xl my-4 text-neutral'>tel. +420 736 763 715 nebo tel. +420 605 953 718</p>
            </div>

            <div className='flex flex-col items-center py-32 bg-base-200'>
                <h2 className="text-2xl mb-4 text-neutral">Jak probíhá spolupráce</h2>
                <p className='text-sm text-neutral'>Snažíme se naše klienty zbytečně nezatěžovat. Spolupráce se soustředí na 4 základní kroky. Používáme stejný pracovní postup již 19 roků.</p>
