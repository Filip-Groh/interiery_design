...
export default async function Home() {
    ...
    return (
        <div className='flex flex-col items-center px-4'>
            ...
            <div className='text-neutral flex flex-row sm:h-[40rem] max-w-7xl max-sm:flex-col-reverse'>
            ...
            <div className='text-neutral flex sm:flex-row flex-col max-w-7xl max-sm:mt-8 gap-4' id="showcase">
            ...
            <div className='text-neutral sm:mt-24 mt-8 max-w-7xl sm:mx-8'>
            ...
            <div className='text-neutral sm:mt-24 mt-8 max-w-7xl'>
            ...
            <div className='text-neutral sm:mt-24 mt-8 max-w-7xl w-full'>
            ...
            <div className='text-neutral sm:mt-24 mt-8 flex sm:flex-row flex-col max-w-7xl sm:mx-8'>
