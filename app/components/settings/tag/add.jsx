...
const AddTag = ({modalId}) => {
    return (
        <button className="w-8 h-8 m-2 bg-base-100 rounded-lg" onClick={()=>document.getElementById(modalId).showModal()}>
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="25px" height="25px" viewBox="0 0 122.88 119.72" xmlSpace="preserve" className="w-8 h-8 p-2">
                <g>
